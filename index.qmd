...
dreamy_mean = patients_df[patients_df['doctor_name'] == 'Doc Dreamy']['post_surgical_score'].mean()
duck_mean = patients_df[patients_df['doctor_name'] == 'Doc Duck']['post_surgical_score'].mean()
...
# Set x-axis limits (no need to extend for annotations anymore)
ax.set_xlim(-2, 102)

# Add legend (positioned to avoid overlap with mean box)
ax.legend(loc='upper left', fontsize=11, framealpha=0.9)

# Create a text box on the side with mean values
mean_text = f'Mean Values:\n○ Doc Dreamy: {dreamy_mean:.2f}\n△ Doc Duck: {duck_mean:.2f}'
ax.text(0.98, 0.98, mean_text, transform=ax.transAxes,
...
# Calculate means for each doctor using randomized data
dreamy_mean = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Dreamy']['post_surgical_score'].mean()
duck_mean = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Duck']['post_surgical_score'].mean()
...
# Add shaded region highlighting severity between -1 and 1 (stratification region)
ax.axvspan(-1, 1, alpha=0.15, color='gray', zorder=0, label='Stratification Region')
